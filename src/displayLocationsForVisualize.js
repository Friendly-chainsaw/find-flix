    ...
    for (let i = 0; i < arrayProviders.length; i++) {
      ...
      switch (arrayProviders[i].logo_path) {
        ...
        case "/5NyLm42TmCqCMOZFvH4fcoSNKEW.jpg":
          addClick(
            newStreamingServiceImage,
            `https://www.amazon.com/s?k=${movieName.replaceAll(
              " ",
              "+"
            )}&i=instant-video`
          );
        ...
        case "/peURlLlr8jggOwK53fJ5wdQl05y.jpg":
          addClick(
            newStreamingServiceImage,
            `https://tv.apple.com/search?term=${movieName.replaceAll(
              " ",
              "%20"
            )}`
          );
        ...
        case "/tbEdFQDwx5LEVr8WpSeXQSIirVq.jpg":
          addClick(
            newStreamingServiceImage,
            `https://play.google.com/store/search?q=${movieName.replaceAll(
              " ",
              "%20"
            )}`
          );
        ...
        case "/2pCbao1J9s0DMak2KKnEzmzHni8.jpg":
          addClick(
            newStreamingServiceImage,
            `https://www.sky.com/new-search?q=${movieName.replaceAll(
              " ",
              "%20"
            )}`
          );
        ...
        case "/cksgBjTHV3rzAVaO2zUyS1mH4Ke.jpg":
          addClick(
            newStreamingServiceImage,
            `https://uk.chili.com/search?q=${movieName.replaceAll(" ", "+")}`
          );
          break;
        // microsoft
        case "/shq88b09gTBYC4hA7K7MUL8Q4zP.jpg":
          addClick(
            newStreamingServiceImage,
            `https://www.microsoft.com/en-gb/search/explore?q=${movieName.replaceAll(
              " ",
              "+"
            )}`
          );
        ...
        case "/oIkQkEkwfmcG7IGpRR1NB8frZZM.jpg":
          addClick(
            newStreamingServiceImage,
            `https://www.youtube.com/results?search_query=${movieName.replaceAll(
              " ",
              "+"
            )}`
          );
        ...
        case "/5GEbAhFW2S5T8zVc1MNvz00pIzM.jpg":
          addClick(
            newStreamingServiceImage,
            `https://rakuten.tv/uk/search?q=${movieName.replaceAll(" ", "%20")}`
          );
          break;
      }
